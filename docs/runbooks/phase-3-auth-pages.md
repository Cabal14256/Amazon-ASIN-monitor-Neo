...
关联 Issue #55。接入现有七个 auth service、共享权限策略与设计基础，完成登录、403、个人中心三个页面及全部 15 个业务路径的权限入口。在本批合入时，首页、ASIN、监控、分析、设置、运维、用户、审计、任务等其余 12 个页面均显示“此页面暂不可用”；完整应用外壳和这些业务功能仍待迁移，不能将本批作为 P3 出口或生产切流证据。首页和应用外壳的后续进度见 [Home 工作台](phase-3-home-workspace.md)。
