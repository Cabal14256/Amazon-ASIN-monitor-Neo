...
function enqueue(countries, batchConfig = null, options = {}) {
  ...
  const scheduledJobId = buildScheduledJobId(
    competitorMonitorTaskQueue.name,
    taskData,
  );
  ...
  return competitorMonitorTaskQueue.add(taskData, jobOptions);
}
