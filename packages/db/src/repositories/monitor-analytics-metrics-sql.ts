...
export function monitorAggregateMetricsSelect(base: SQL): SQL {
  ...
  return sql`WITH base AS (${base}), asin_metrics AS (
    SELECT base.group_key, base.group_label, base.asin_key,
      ...
      FROM base WHERE base.bucket_hours>0 GROUP BY base.group_key, base.group_label, base.asin_key
    ...
    FROM asin_metrics GROUP BY group_key, group_label ORDER BY group_key ASC, group_label ASC`;
}
